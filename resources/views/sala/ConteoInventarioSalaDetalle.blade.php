                ...
                <div class="card-header">
                    ...
                    <div class="form-group" id="input_fields_wrap">
                               ...
                               <!--  <div class="row">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a href="{{ route('ConteoInventarioSala') }}" class="btn btn-warning">Atras</a>
                                    </div>
            ...
            <div class="modal-dialog" role="document" >
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ route('CargarValeConteoSala', ['id_conteo' => $id_conteo]) }}" id="desvForm" >
                            <div class="card card-primary">
                                <div class="card-body">
        ...
        <div class="modal fade" id="modalterminarconteo" tabindex="-1" role="dialog"
            ...
            <div class="modal-dialog" role="document" >
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <form method="post" action="{{ route('TerminarConteoSala', ['id_conteo' => $id_conteo]) }}" id="desvForm" >
                            <div class="card card-primary">
                                <div class="card-body">
            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="form-group" id="input_fields_wrap">
                                ...
                                <div class="row">
                                    <div class="col">
                                        <a href="{{ route('ConteoInventarioSala') }}" class="btn btn-warning"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                                    </div>
                                    <div class="col d-flex justify-content-center">

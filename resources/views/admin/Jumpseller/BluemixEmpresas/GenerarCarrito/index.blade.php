            ...
            <table id="productos" class="table table-bordered table-hover dataTable">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-right">$ {{number_format($item->DZ_PRECIO * $item->DZ_CANT,0,',','.')}}</th>
                    </tr>
                    ...
                    <tfoot>
                        <tr>
                          ...
                          <td class="text-right" ><span class="price text-success">${{number_format($cotizacion->CZ_MONTO,0,',','.')}}</span></td>

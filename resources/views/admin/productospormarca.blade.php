                ...
                <form action="{{ route('ProductosPorMarcafiltrar') }}" method="post" id="desvForm" class="form-inline">
                    ...
                    <div class="form-group mx-sm-3 mb-2">
                        @if (empty($marca))
                            ...
                            <input type="text" name="marca" id="marca" class="form-control input-lg" autocomplete="off"
                                placeholder="Marca....">
                            <div style="position: absolute;" id="List">
                            </div>
                        @else
                            <input type="text" name="marca" class="form-control input-lg" placeholder="Marca...."

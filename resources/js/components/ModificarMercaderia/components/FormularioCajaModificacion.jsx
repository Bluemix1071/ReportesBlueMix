...
const FormularioCajaModificacion = (props) => {
    ...
    <Fragment>
        <form onSubmit={handleSubmit(onSubmit)} ref={props.myForm} className="needs-validation" >
            ...
            <div className="form-row">
                ...
                <div className="col-md-4 mb-3">
                    <label>Estado</label>
                    <select className="custom-select" name="estado"  required
                        ref={
                            register({
                                required: {
                                    value: true,
...
export default FormularioCajaModificacion;

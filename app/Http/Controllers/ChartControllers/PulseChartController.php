...
class PulseChartController extends Controller
{
 ...
 if ($request->select1==null ||$request->select2 ==null||$request->select3==null) {
   ...
   return redirect('/graficos')->withErrors(['error'=>'ingrese algun valor en los campos']);
   } elseif ($request->select1=='2019' ||$request->select2 ==null||$request->select3==null) {
      $C3->dataset('2019', 'line', [$a2019[0]->total,$a2019[1]->total,$a2019[2]->total,$a2019[3]->total,$a2019[4]->total,$a2019[5]->total,$a2019[6]->total,$a2019[7]->total]);
      return view('graficos/pruebaChart', compact('chart','C3'),);
   }elseif($request->select1==null ||$request->select2 =='2019'||$request->select3==null) {
      $C3->dataset('2019', 'line', [$a2019[0]->total,$a2019[1]->total,$a2019[2]->total,$a2019[3]->total,$a2019[4]->total,$a2019[5]->total,$a2019[6]->total,$a2019[7]->total]);
      return view('graficos/pruebaChart', compact('chart','C3'),);
   }elseif($request->select1==null ||$request->select2 ==null||$request->select3=='2019'){
      $C3->dataset('2019', 'line', [$a2019[0]->total,$a2019[1]->total,$a2019[2]->total,$a2019[3]->total,$a2019[4]->total,$a2019[5]->total,$a2019[6]->total,$a2019[7]->total]);
      return view('graficos/pruebaChart', compact('chart','C3'),);
   }else{
      $C3->dataset(''.$request->select1.'', 'line', [$a2017[0]->total,$a2017[1]->total,$a2017[2]->total,$a2017[3]->total,$a2017[4]->total,$a2017[5]->total,$a2017[6]->total,$a2017[7]->total,$a2017[8]->total,$a2017[9]->total,$a2017[10]->total,$a2017[11]->total,]);
      $C3->dataset(''.$request->select2.'', 'line', [$a2018[0]->total,$a2018[1]->total,$a2018[2]->total,$a2018[3]->total,$a2018[4]->total,$a2018[5]->total,$a2018[6]->total,$a2018[7]->total,$a2018[8]->total,$a2018[9]->total,$a2018[10]->total,$a2018[11]->total,]); 
      $C3->dataset(''.$request->select3.'', 'line', [$a2019[0]->total,$a2019[1]->total,$a2019[2]->total,$a2019[3]->total,$a2019[4]->total,$a2019[5]->total,$a2019[6]->total,$a2019[7]->total]);
      return view('graficos/pruebaChart', compact('chart','C3'),);

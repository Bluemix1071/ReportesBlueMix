  ...
  /**
    ...
    public function toMail($notifiable)
    {
        ...
        ->greeting('Hola '.$notifiable->name)
            ->subject(Lang::getFromJson('Notificacion Cambio de Contraseña'))
            ...
            ->line(Lang::getFromJson('Este enlace para restablecer la contraseña caducará en :count minutes.', ['count' => config('auth.passwords.'.config('auth.defaults.passwords').'.expire')]))

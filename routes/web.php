...
Route::prefix('admin')->namespace('Admin')->middleware(['auth', 'SuperAdmin'])->group(function () {
    ...
    Route::post(
        '/admin/listaescolar/eliminar-todos',
    ...
    Route::post('/MantencionClientesCreditoDetalle', 'MantencionClientesCreditoController@DetalleCliente')->name('MantencionClientesCreditoDetalle');
    Route::get('/buscacliente', 'MantencionClientesCreditoController@buscacliente')->name('buscacliente');
    Route::post('/guardar-registro', 'MantencionClientesCreditoController@GuardarRegistro')->name('guardar.registro');
    ...
    Route::post('/errordesc', 'Rectificacion\RectificacionInventarioSalaController@errordesc')->name('errordesc');
    ...
    Route::get('/exportExcelStockTiempoReal', 'exports\ExportsController@exportExcelStockTiempoReal')->name('exportExcelStockTiempoReal');
    ...
    // Stock Historico
    Route::get('/StockHistorico', 'StockHistoricoController@index')->name('StockHistorico');
    Route::get('/StockHistoricoData', 'StockHistoricoController@getStockData')->name('StockHistoricoData');
    Route::get('/StockHistoricoExportExcel', 'StockHistoricoController@exportExcel')->name('StockHistoricoExportExcel');
    Route::get('/StockHistoricoExportPdf', 'StockHistoricoController@exportPdf')->name('StockHistoricoExportPdf');
